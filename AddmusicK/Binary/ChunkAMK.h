...
using YoshiCh5 = ChunkTemplate<1, CmdType::ExtF4, CmdOptionF4::YoshiCh5>;
using Legato = ChunkTemplate<1, CmdType::ExtF4, CmdOptionF4::Legato>;
using LightStaccato = ChunkTemplate<1, CmdType::ExtF4, CmdOptionF4::LightStaccato>;
using EchoToggle = ChunkTemplate<1, CmdType::ExtF4, CmdOptionF4::EchoToggle>;
using Sync = ChunkTemplate<1, CmdType::ExtF4, CmdOptionF4::Sync>;
using Yoshi = ChunkTemplate<1, CmdType::ExtF4, CmdOptionF4::Yoshi>;
using TempoImmunity = ChunkTemplate<1, CmdType::ExtF4, CmdOptionF4::TempoImmunity>;
using VelocityTable = ChunkTemplate<1, CmdType::ExtF4, CmdOptionF4::VelocityTable>;
using RestoreInst = ChunkTemplate<1, CmdType::ExtF4, CmdOptionF4::RestoreInst>;
